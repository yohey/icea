subroutine run_example_04()
  use cea
  implicit none

  type(CEA_Problem):: prob

  call prob%set_problem(mode = 'uv', name = 'Example 4')
  ...
  call prob%set_chamber_internal_energy(-45.1343d0)

  call prob%set_chamber_densities([14.428d0], unit = 'kg/m^3')
  ...
  call prob%run(out_filename = 'example-04.out')

  return
end subroutine run_example_04
