...
void run_example_01() {
  ...
  prob.set_problem("tp", "Example 1", true);
  ...
  prob.add_reactant("fuel", "H2",  std::nullopt, 1.0);
  prob.add_reactant("oxyd", "Air", std::nullopt, 1.0);

  prob.set_chamber_pressures({1.0, 0.1, 0.01}, "atm");
  prob.set_chamber_temperatures({3000, 2000});
  prob.set_mixture_ratios({1.0, 1.5}, "eq.ratio");
